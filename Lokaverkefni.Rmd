...
haha <- plot[-1,] %>%
  filter(value>0) %>%
  arrange(-value)
rownames(haha) <- c("Seltjarnarnes", "Hafnarfjörður", "Garage", "Floor", "Year Bought", "Property type", "Garðabær","Bathrooms", "Mosfellsbær", "Showers", "Elevator",  "Kitchens") #keyra coef(lasso.mod) til að sjá hvaða rownames eiga að vera hér
haha %>%
