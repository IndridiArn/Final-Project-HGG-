...
f1 <- data %>% ggplot(aes(x=nuvirdi,y=svfn, fill=svfn)) +
  ...
  ggtitle("Figure 1: Property price based on ") + xlim(c(0,100000)) + 
...
In figure 1 we see the property price based on the municipality on the one hand and neighbourhood on the other. Overall, the property prices seem to have a fairly normal distribution. 
