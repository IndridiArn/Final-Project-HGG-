...
```
  ...
  First we obtained 25 dimensions from the factor analysis that collectively explained around 66% of data variance. Neighbourhood had no correlation to any of the dimensions so it will be removed for further analysis. 
...
As shown in figure 18, there are three variables out of the four that have higher relative importance. They are square meters of property, the year the property was bought and the age of the property. Square meters per property is by far the most important variable, which aligns with the results from before. 
