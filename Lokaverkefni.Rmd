---
title: "Linear times at Ridge-mont high"
...
kbl(kabletable,booktabs=T, caption = "Table 2: Quadratic discrimnant analysis") %>% 
...
kbl(kabletable2,booktabs=T, caption = "Table 3: Logistic Regression") %>% 
  kable_styling(full_width = F, position = "center") %>%
...
kbl(kabletableRF,caption = "Table 4: Random Forest") %>% 
  kable_styling(full_width = F, position = "center") %>%
  add_header_above(c(" " = 1, "True values" = 2)) 
...
old %>%
  kable(caption = "Table 5: Comparison of QDA, LR and Random forest") %>%
  kable_styling(full_width = F)
```
