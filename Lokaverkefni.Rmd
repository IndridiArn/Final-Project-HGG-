...
Figure 1 shows the distribution of property worth based on the municipality on one hand, and neighbourhood on the other. They are mostly right skewed. The highest average property worth are in Seltjarnarnes ($\mu \approx$ 52 m.ISK), Garðabær ($\mu \approx$ 49 m.ISK). The lowest in Hafnarfjörður ($\mu \approx$ 35 m.ISK) and Reykjavík ($\mu \approx$ 35 m.ISK). 
