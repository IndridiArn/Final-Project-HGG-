...
data.frame(mse=test.MSE, 
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank(), legend.position = "none") + ggtitle("Figure X: Test MSE for a range of lambda values") + annotate(geom="text",y=10^7.8, x=10^0, label= expression(paste(lambda, "= 0.79")))
```
