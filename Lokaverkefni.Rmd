...
data <- data %>% select(kdagur, nuvirdi, teg_eign, byggar, lyfta, ibm2, fjhaed, fjbilsk, fjbkar, fjsturt, fjklos, fjeld, fjherb, fjstof, fjgeym, matssvaedi, ibteg, svfn) %>%
...
data$year <- format(data$kdagur, format="%Y")
data$age <- (as.numeric(data$year)-data$byggar)
