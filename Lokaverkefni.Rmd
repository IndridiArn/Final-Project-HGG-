...
```{r, fig.align = 'center'}
# price per square meter by municipalityf
data <- data %>% 
...
haha <- plot[-1,] %>%
  filter(value>0) %>%
  arrange(-value)
rownames(haha) <- c("Seltjarnarnes", "Prop. Type", "Toilets", "Kitchens", "Garðabær", "Parking", "Hafnarfjörður","Living rooms", "Showers","Sales Year", "Rooms", "Bathtubs", "Floors", "Elevator")
haha %>%
