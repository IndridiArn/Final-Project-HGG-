...
LAGA: FERMETRAVERÐ á ekki að vera í plottinu!

As shown in figure 15, there are four variables that have high relative importance. They are square meters of property, the year the property was bought, the age of the property and at last, municipality the property is in. Square meters per property is by far the most important variable. In figures X and X in part I we learned that the more square meters are in a property the more expensive it is. We also learned that property prices increase the younger the property is. 


LAGA. BERGRÓS, gætir þú tékkað á hvort hún sé rétt? Erum að fá þvílíkt lág gildi með Boosting m.v. Lasso. 
```{r}
